...
public class MiniMapControllerTest {
    ...
    public void setUp() throws URISyntaxException, IOException {
        ...
        Graph<SequenceSegment> graph = parser.parseGraph(vertexfile, edgefile, factory);
        GraphContainer model = new GraphContainer(graph, new DefaultSequence("reference"));
    ...
    public void drawMiniMapTest() {
        ...
        Paint fill = controller.getMiniMap().getBackground().getFills().get(0).getFill();
