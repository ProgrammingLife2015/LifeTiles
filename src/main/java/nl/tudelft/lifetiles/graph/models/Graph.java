...
public interface Graph<V extends Comparable<V>> {
     ...
     */
    List<Edge<V>> getIncoming(V vertex);
     ...
     */
    List<Edge<V>> getOutgoing(V vertex);

    /**
     * @return A List of source nodes. Source being a node that has no incoming
     *         edges.
     */
    List<V> getSources();
    ...
    /**
     * @return A List of sink nodes. Sink being a node that has no outgoing
     *         edges.
     */
    List<V> getSinks();
